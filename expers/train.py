...
def main_worker(args):
    ...
    if not args.test_mode:
        ...
        last_index = eval_tt_df.index[-1]
        eval_tt_df.loc[last_index + 1, 'diceT'] = avg_dice
        eval_tt_df.loc[last_index + 1, 'hd95T'] = avg_hd95
        eval_tt_df.fillna('', inplace=True)
        eval_tt_df.rename(index={last_index + 1: 'Avg.'}, inplace=True)
