...
def get_parser(argv):
    ...
    parser.add_argument("--use_pretrained", default=None, action=argparse.BooleanOptionalAction, help="Using pretrained weights")
    parser.add_argument("--pretrained_path", default=None, type=str, help="Using pretrained weights path")
