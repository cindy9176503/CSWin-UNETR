...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=96, patch_size=16, in_chans=1, num_classes=1000, embed_dim=96, depth=[2,2,6,2], split_size = [3,5,7],
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, use_chk=False, first_stage_divide=4):
        super().__init__()
    ...
    def forward(self, x):
        ...
        layers01 = [self.merge1, self.merge2]
        layers02 = [self.stage2, self.stage3]
